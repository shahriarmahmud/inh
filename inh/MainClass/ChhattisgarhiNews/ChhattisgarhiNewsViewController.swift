//
//  ChhattisgarhiNewsViewController.swift
//  inh
//
...
//    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if(indexPath.row==0){
            ...
            let cellHeader:ChhattisgarhiNewsTableViewCell = tableView.dequeueReusableCell(withIdentifier: "cell_header", for: indexPath) as! ChhattisgarhiNewsTableViewCell
...
//            }
            ...
            let cell:ChhattisgarhiNewsTableViewCell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! ChhattisgarhiNewsTableViewCell
...
//                }
    ...
    func loadMoreData(count:String){
        ...
        Alamofire.request(RequestString.chatisgariNewsLoadMore+count, method: .get, encoding: JSONEncoding.default).responseJSON { responce in
    ...
    func GEtReportDate(){
        ...
        Alamofire.request(RequestString.chatisgariNews, method: .get, encoding: JSONEncoding.default).responseJSON { responce in
            switch responce.result{
            case.success(let data):
                SVProgressHUD.dismiss()
                self.refreshControl.endRefreshing()
