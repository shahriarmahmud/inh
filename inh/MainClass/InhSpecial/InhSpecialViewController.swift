//
//  InhSpecialViewController.swift
//  inh
//
...
class InhSpecialViewController: BaseViewController , UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if(indexPath.row==0){
            ...
            let cellHeader:InhSpecialTableViewCell = tableView.dequeueReusableCell(withIdentifier: "cell_header", for: indexPath) as! InhSpecialTableViewCell
            ...
            let cell:InhSpecialTableViewCell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! InhSpecialTableViewCell
    ...
    func GEtReportDate(){
        ...
        Alamofire.request(RequestString.inhSpecial, method: .get, encoding: JSONEncoding.default).responseJSON { responce in
            switch responce.result{
            case.success(let data):
                SVProgressHUD.dismiss()
                let json = JSON(data)
