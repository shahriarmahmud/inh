//
//  BollywoodExpressViewController.swift
//  inh
//
...
//    }
    ...
    func loadMoreData(count:String){
        ...
        Alamofire.request(RequestString.bollywoodExpressLoadMore+count, method: .get, encoding: JSONEncoding.default).responseJSON { responce in
    ...
    func GEtReportDate(){
        ...
        Alamofire.request(RequestString.bollywoodExpress, method: .get, encoding: JSONEncoding.default).responseJSON { responce in
            switch responce.result{
            case.success(let data):
                SVProgressHUD.dismiss()
                self.refreshControl.endRefreshing()
