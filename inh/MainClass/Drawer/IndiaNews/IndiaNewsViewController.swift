...
class IndiaNewsViewController: BaseViewController , UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell:IndiaNewsTableViewCell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! IndiaNewsTableViewCell
        ...
        if(indexPath.row==0){
            ...
            let cellHeader:IndiaNewsTableViewCell = tableView.dequeueReusableCell(withIdentifier: "cell_header", for: indexPath) as! IndiaNewsTableViewCell
    ...
    func loadMoreData(count:String){
        ...
        Alamofire.request(RequestString.drawerIndiaNewsLoadMore+count, method: .get, encoding: JSONEncoding.default).responseJSON { responce in
    ...
    func GEtServerDate(){
        ...
        Alamofire.request(RequestString.drawerIndiaNews, method: .get, encoding: JSONEncoding.default).responseJSON { responce in
            switch responce.result{
            case.success(let data):
                SVProgressHUD.dismiss()
                self.refreshControl.endRefreshing()
