...
//    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if(indexPath.row==0){
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as! EntertainmentTableViewCell
        ...
        else
        {
            ...
            let cell:EntertainmentTableViewCell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as! EntertainmentTableViewCell
    ...
    func loadMoreData(count:String){
        ...
        Alamofire.request(RequestString.drawerEntertainmentLoadMore+count, method: .get, encoding: JSONEncoding.default).responseJSON { responce in
